...
Singleton {
    ...
    readonly property var availableModes: Mem.options.bar.workspaces.availableModes ?? ["normal", "japanese", "latin", "custom", "words"]
