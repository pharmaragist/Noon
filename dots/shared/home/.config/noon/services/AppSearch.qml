...
Singleton {
    ...
    readonly property var substitutions: Mem.options.desktop.icons.substitutions ?? ({})
    readonly property var regexSubstitutions: Mem.options.desktop.icons.regexSubstitutions ?? ({})
